...
class Settings(BaseSettings):
    ...
    ALLOWED_ORIGINS: list[str] = ["http://localhost:3000", "https://saidika-crm.onrender.com", "http://localhost:5173", "http://localhost:8000", "https://bidii-credit-ltd.vercel.app", "https://saidika-zeta.vercel.app"]
